...
exports.runJobs = function()
{
  ...
  for (var n = 0; n < Math.min(imageJobsNotRunning.length - imageJobsRunningCount, 4); n++)
  {
  ...
  for (var n = 0; n < jobsToStart.length; n++)
  {
    ...
    exports.create(path.join(__dirname, "..", "files", options.id), options, function(error)
    {
...
exports.get = function(options, callback)
{
  ...
  options.filepath = path.join(__dirname, "..", "cache", filename);

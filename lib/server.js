...
//     {
//       utils.template.compile(murrix.basePath() + "public/index.html.tmpl", function(error, data)
//       {
//         if (error)
//         {
//           logger.error("Could not compile template file, reason: " + error);
...
/*
    ...
    server.listen(9090);
    logger.debug("Listening to port 9090...");

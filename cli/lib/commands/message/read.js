...
.action(vorpal.wrap(function*(args) {
    let message = yield api.vfs.messageRead(typeof args.index !== "undefined" ? parseInt(args.index) : undefined);
    let username = yield api.vfs.uname(message.node.attributes.from);

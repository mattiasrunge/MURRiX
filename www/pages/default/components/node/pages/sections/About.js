...
class About extends Component {
    ...
    async load() {
        ...
        try {
            const age = await api.murrix.age(this.props.node.path);
            const partner = await api.murrix.getpartner(this.props.node.path);
            const children = await api.murrix.getchildren(this.props.node.path);
            const mother = await api.murrix.getparent(this.props.node.path, "f");
            const father = await api.murrix.getparent(this.props.node.path, "m");

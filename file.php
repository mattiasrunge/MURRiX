    ...
    if(count($ranges)>1){
      ...
      */
      ...
      foreach ($ranges as $range){
        ...
        $content_length+=strlen("Content-type: video/webm\r\n");
...
{
  echo $gDatabase->error . ": " . $query . ", code:" . ERROR_CODE_DB;
}

while ($preview = $result->fetch_assoc())
{
  ...
  {
    byteserve($gPreviewPaths . $preview['Id'] . ".webm"); //byteserve it!
  }
  else
  {
    header("Content-Type: image/jpg"); 
    echo base64_decode($preview['Data']);
  }
